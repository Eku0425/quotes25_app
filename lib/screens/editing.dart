                ...
                boxcat(
                  InkWell(
                    onTap: () async {
                      ...
                      editingKey[index].currentContext!.findRenderObject()
                        ...
                        builder: (context) {
                          return AlertDialog(
                            ...
                            actions: [
                              ...
                              TextButton(
                                  onPressed: () async {
                                    RenderRepaintBoundary boundary = editingKey[index]
                                        .currentContext!
                                        .findRenderObject()
                                    as RenderRepaintBoundary;
